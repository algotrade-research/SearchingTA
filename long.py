...
# search_study = optuna.load_study(study_name='searching_', storage=f'sqlite:///searching.db')
...
# optimize_study = optuna.load_study(study_name=f'optimizing_{best_search_trial}', storage=f'sqlite:///searching.db')
